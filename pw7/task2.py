...
def parse_coefficient_and_formula(component: str) -> tuple:
    """
    This function Splits a molecule component into its coefficient and formula.

    Args:
        component (str): Molecule with coefficient. Example: "2H2".
...
def is_balanced_equation(equation: str) -> bool:
    """
    Checks if a chemical equation is balanced. (Task 2e)
